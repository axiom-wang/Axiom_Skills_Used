---
name: folo-cli
description: Manage Folo RSS reader via the folocli command-line tool. Use when the user wants to manage RSS subscriptions, browse timeline entries, read entries, mark read/unread, search feeds/lists/trending sources, import/export OPML, or check unread counts.
---
